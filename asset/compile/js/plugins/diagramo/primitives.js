...
QuadCurve.prototype = {
    ...
    deprecated_contains:function(x, y){
        ...
        var points=[this.startPoint,this.controlPoint,this.endPoint];
...
Figure.load = function(o){
    ...
    newFigure.id = o.id;
    newFigure.figureType = o.figureType;
    newFigure.figureParam = o.figureParam;
    newFigure.funcType = o.funcType;
    newFigure.x = o.x;
    newFigure.y = o.y;
    if (newFigure.funcType == "image_click") {
        newFigure.doubleClickFunc = doubleClickFunc;
        newFigure.unDoubleClickFunc = unDoubleClickFunc;
    }
...
if(typeof(document) == 'undefined'){ //test only from console
    ...
    print("\n--==Line==--\n");
    var l = new Line(new Point(10, 23), new Point(34, 50));
    print(l);
    print("\n");
    ...
    print("\n--==Quad curve==--\n");
    var q = new QuadCurve(new Point(75,25), new Point(25,25), new Point(25,62))
    print(q)
    ...
    print("\n--==Cubic curve==--\n");
    var q = new CubicCurve(new Point(75,40), new Point(75,37), new Point(70,25), new Point(50,25))
    print(q)
