...
(function () {
    var r = function (d, j) {
        ...
        var e = 1, k = /^\s*(\d+)((px)|\%)?\s*$/i, w = /(^\s*(\d+)((px)|\%)?\s*$)|^$/i, o = /^\d+px$/,
            x = function () {
                var a = this.getValue(), b = this.getDialog(), c = a.match(k);
                c && ("%" == c[2] && l(b, !1), a = c[1]);
                ...
                if ("check" == b) {
                    if (!a.userlockRatio && "true" == c.getCustomData("isReady")) {
                        var d = a.getValueOf("info", "txtWidth"), e = a.getValueOf("info", "txtHeight"), c = 1E3 * c.$.width / c.$.height, g = 1E3 * d / e;
                        a.lockRatio = !1;
                ...
                if ("true" == c.getCustomData("isReady")) {
                    var d = a.getContentElement("info", "txtWidth"), e = a.getContentElement("info", "txtHeight"), g;
                ...
                if (a == e) {
                    var d = this.getDialog(), f = "", g = "txtWidth" == this.id ? "width" : "height", h = b.getAttribute(g);
                    h && (f = c(h, f));
                    f = c(b.getStyle(g), f);
                    this.setValue(f)
                }
        ...
        return {
            ...
            onShow: function () {
                ...
                this.firstLoad = !0;
                this.addLink = !1;
                var a = this.getParentEditor(), b = a.getSelection(), c = (b = b && b.getSelectedElement()) && a.elementPath(b).contains("a", 1), d = CKEDITOR.document.getById(m);
                ...
                this.imageEditMode && (this.cleanImageElement = this.imageElement, this.imageElement = this.cleanImageElement.clone(!0,
                    !0), this.setupContent(e, this.imageElement));
                l(this, !0);
            ...
            contents: [{
                ...
                id: "Link", requiredContent: "a[href]", label: d.lang.image.linkTab, padding: 0, elements: [{
                    ...
                    "default": "",
                    items: [[d.lang.common.notSet, ""], [d.lang.common.targetNew, "_blank"], [d.lang.common.targetTop, "_top"], [d.lang.common.targetSelf, "_self"], [d.lang.common.targetParent,
                        "_parent"]],
                    setup: function (a, b) {
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        "default": "",
                        items: [[d.lang.common.notSet, ""], [d.lang.common.langDirLtr, "ltr"], [d.lang.common.langDirRtl,
                            "rtl"]],
                        setup: function (a, b) {
                    ...
                    label: d.lang.common.longDescr, setup: function (a, b) {
                    ...
                    setup: function (a, b) {
                        if (a == e) {
                            ...
                            this.setValue(c);
                            var d = b.$.style.height, c = b.$.style.width, d = (d ? d : "").match(k), c = (c ? c : "").match(k);
